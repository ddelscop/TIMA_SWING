...
package logicaPersistencia.accesoBD;
	...
	* /** A class for preallocating, recycling, and managing
	 ...
	 * 
	 * http://archive.coreservlets.com/Javadoc/coreservlets/ConnectionPool.html
	 *
	 */
	public class ConnectionPool implements Runnable {
	    ...
	    public synchronized Connection getConnection()
	            throws SQLException {
	        //System.out.println("Antes de coger conexion:" + totalConnections());
	        //System.out.println("availableConnections:" + availableConnections.toString());
	        //System.out.println("busyConnections:" + busyConnections.toString());
